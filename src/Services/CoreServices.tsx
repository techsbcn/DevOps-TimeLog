...
export const getProjectPageService = async () => {return await SDK.getService<IProjectPageService>(CommonServiceIds.ProjectPageService)}
...
export const getTeamMembers = async (projectId: string, teamId: string) => coreRestClient.getTeamMembersWithExtendedProperties(projectId, teamId)
